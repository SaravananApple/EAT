...
const ExternalErrorEditModalField = (props) => {
  const {
    field,
    label,
    registerOptions,
  ...
  const renderInput = ({ field: formField, formState }) => {
    ...
    if (formField.name === "define_error") {
      input = (
        <InputText
          id={field}
          onChange={(e) => onInputChange(e)}
    ...
    if (formField.name === "determine_root_cause") {
      input = (
        <InputText
          id={field}
          onChange={(e) => onInputChange(e)}
    ...
    if (formField.name === "corrective_action") {
      input = (
        <InputText
          id={field}
          onChange={(e) => onInputChange(e)}
    ...
    if (formField.name === "preventive_action") {
      input = (
        <InputText
          id={field}
          onChange={(e) => onInputChange(e)}
...
export default ExternalErrorEditModalField;
